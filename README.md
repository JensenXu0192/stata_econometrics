...
All the stata code can be found in the paper_do file in the log folder. The rtf files are the regression outputs and descriptive statistics. I recommend using Microsoft Word to open the rtf files, but if you prefer reading them in other formats you can always change the output file type in the do file.
